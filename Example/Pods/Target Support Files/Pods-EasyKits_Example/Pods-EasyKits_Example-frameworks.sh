...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/EasyKits/EasyKits.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleAServices/ModuleAServices.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleB/ModuleB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleBServices/ModuleBServices.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleServices/ModuleServices.framework"
